...
<div id="networth" class="section active" role="tabpanel" aria-labelledby="tab-networth">
  ...
  <div id="nw-content" style="display:none">
    ...
    <div class="card card-primary">
      ...
      <div class="chart-wrap chart-h-lg"><canvas id="c-nw-hist" role="img" aria-label="Net worth over time chart"></canvas></div>
    ...
    <div id="port-content" style="display:none">
      ...
      <div class="two-col">
        <div class="card">
          ...
          <div class="chart-wrap chart-h-sm"><canvas id="c-port-donut" role="img" aria-label="Portfolio allocation donut chart"></canvas></div>
        </div>
        <div class="card">
  ...
  <div class="subview" id="subview-contributions" role="tabpanel" aria-labelledby="tab-contributions" style="display:none">
    ...
    <div id="dca-content" style="display:none">
      ...
      <div class="card card-primary">
        ...
        <div class="chart-wrap chart-h-lg"><canvas id="c-dca-bar" role="img" aria-label="Monthly contributions bar chart"></canvas></div>
      </div>
      <div class="two-col">
        <div class="card">
...
<div id="analytics" class="section" role="tabpanel" aria-labelledby="tab-analytics">
  ...
  <div id="an-content" style="display:none">
    ...
    <div class="card card-primary">
      ...
      <div class="chart-wrap chart-h-lg"><canvas id="c-an-growth" role="img" aria-label="Portfolio growth chart"></canvas></div>
    ...
    <div id="an-level2">
      <div class="card">
        ...
        <div class="chart-wrap chart-h-md"><canvas id="c-an-contrib" role="img" aria-label="Annual contributions chart"></canvas></div>
      ...
      <div class="two-col">
        <div class="card">
          ...
          <div class="chart-wrap chart-h-sm"><canvas id="c-an-alloc-acct" role="img" aria-label="Allocation by account chart"></canvas></div>
        </div>
        <div class="card">
          ...
          <div class="chart-wrap chart-h-sm"><canvas id="c-an-alloc-class" role="img" aria-label="Allocation by asset class chart"></canvas></div>
        </div>
      </div>
      ...
      <div class="two-col">
        <div class="card">
          ...
          <div class="chart-wrap chart-h-sm"><canvas id="c-an-alloc-region" role="img" aria-label="Allocation by region chart"></canvas></div>
        </div>
      </div>
    </div>
    ...
    <details id="an-advanced" class="card-collapsible" style="margin-top:1rem">
      ...
      <div id="an-advanced-content" style="padding-top:.75rem">
        ...
        <div class="card" id="an-drawdown-card" style="margin:0 0 1rem">
          ...
          <div class="chart-wrap chart-h-md"><canvas id="c-an-drawdown" role="img" aria-label="Portfolio drawdown chart"></canvas></div>
        ...
        <div class="card" id="an-rolling-cagr-card" style="margin:0 0 1rem">
          ...
          <div class="chart-wrap chart-h-md"><canvas id="c-an-rolling-cagr" role="img" aria-label="Rolling CAGR chart"></canvas></div>
        </div>
        ...
        <div id="an-income" style="display:none">
          ...
          <div class="card" style="margin:0 0 1rem">
            ...
            <div class="chart-wrap chart-h-md"><canvas id="c-an-income" role="img" aria-label="Income history chart"></canvas></div>
  ...
  <div id="log-content">
    <div class="card" id="csv-import-card">
      ...
      <div class="card-section" id="tx-ledger-card">
        ...
        <div class="tbl">
          <div id="tx-ledger-wrap"><div id="tx-ledger-list" class="tx-ledger-grid" role="table" aria-label="Transaction ledger"></div></div>
        </div>
